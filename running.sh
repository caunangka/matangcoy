...
# Author  : DOA IBU LEBIH MUSTAJAB 
# (C) Copyright 2021-2099 BY DOA IBU
# =========================================
...
echo -e "         OWNER : ${GREEN}DOA IBU LEBIH MUSTAJAB  ${NC}${YELLOW}(${NC} ${GREEN}JALUR LANGIT ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By DOA IBU  ${YELLOW}(${NC} 2021-2099 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
